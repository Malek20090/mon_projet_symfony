...
- [ ] 1.2 Add add route for CasRelles
- [ ] 1.3 Add edit route for CasRelles
- [ ] 1.4 Add delete route for CasRelles
- [ ] 1.5 Create add template for CasRelles
- [ ] 1.6 Create edit template for CasRelles
...
## Notes
- Form validation must be in PHP (Symfony Validator), NOT JavaScript
