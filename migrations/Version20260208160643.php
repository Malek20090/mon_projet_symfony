...
/**
 * Auto-generated Migration: Salary & Expense + merged tables from main (user, transaction, cas_relles, cours, imprevus, quiz).
 */
final class Version20260208160643 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Salary & Expense (revenue, expense, financial_goal, saving_account) + user, transaction, cas_relles, cours, imprevus, quiz';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE revenue (id INT AUTO_INCREMENT NOT NULL, amount DOUBLE PRECISION NOT NULL, type VARCHAR(20) NOT NULL, received_at DATE NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', user_id INT NOT NULL, INDEX IDX_E9116C85A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
