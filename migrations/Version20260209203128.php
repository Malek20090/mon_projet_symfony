 ...
 */
final class Version20260209203128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(150) NOT NULL, contenu_texte LONGTEXT NOT NULL, type_media VARCHAR(10) NOT NULL, url_media VARCHAR(255) DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_FDCA8C9CA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE crypto (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, symbol VARCHAR(255) NOT NULL, apiid VARCHAR(255) NOT NULL, currentprice DOUBLE PRECISION NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE investissement (id INT AUTO_INCREMENT NOT NULL, amount_invested DOUBLE PRECISION NOT NULL, buy_price DOUBLE PRECISION NOT NULL, quantity DOUBLE PRECISION NOT NULL, created_at DATE NOT NULL, crypto_id INT DEFAULT NULL, objectif_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, INDEX IDX_B8E64E01E9571A63 (crypto_id), INDEX IDX_B8E64E01157D1AD4 (objectif_id), INDEX IDX_B8E64E019D86650F (user_id_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(30) NOT NULL, montant DOUBLE PRECISION NOT NULL, date DATE NOT NULL, description LONGTEXT DEFAULT NULL, module_source VARCHAR(50) DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_723705D1A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(50) DEFAULT NULL, date_inscription DATE DEFAULT NULL, solde_total DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE investissement ADD CONSTRAINT FK_B8E64E019D86650F FOREIGN KEY (user_id_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE investissement DROP FOREIGN KEY FK_B8E64E019D86650F');
