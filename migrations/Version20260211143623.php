 ...
 */
final class Version20260211143623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE expense (id INT AUTO_INCREMENT NOT NULL, amount DOUBLE PRECISION NOT NULL, category VARCHAR(100) NOT NULL, expense_date DATE NOT NULL, description LONGTEXT DEFAULT NULL, revenue_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_2D3A8DA6224718EB (revenue_id), INDEX IDX_2D3A8DA6A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(30) NOT NULL, montant DOUBLE PRECISION NOT NULL, date DATE NOT NULL, description LONGTEXT DEFAULT NULL, module_source VARCHAR(50) DEFAULT NULL, user_id INT NOT NULL, expense_id INT DEFAULT NULL, INDEX IDX_723705D1A76ED395 (user_id), INDEX IDX_723705D1F395DB7B (expense_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) DEFAULT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, date_inscription DATE DEFAULT NULL, solde_total DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
